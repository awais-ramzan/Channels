...
char* test_select() {
    ...
    */
    ...
    print_test_details(__func__, "813");
    sem_wait(&done);
    print_test_details(__func__, "815");
    ...
    print_test_details(__func__, "826");
    ...
    print_test_details(__func__, "834");

    void* data;
    channel_receive(channel[0], &data);
    sem_wait(&done);
    print_test_details(__func__, "839");
