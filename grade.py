...
timeout_cpu_utilization = 300
timeout_response_time = 300
...
iters_cpu_utilization = 1
iters_response_time = 1
...
add_test_cases("test_response_time", iters_response_time, timeout_response_time)
add_test_cases("test_cpu_utilization_send", iters_cpu_utilization, timeout_cpu_utilization)
add_test_cases("test_cpu_utilization_receive", iters_cpu_utilization, timeout_cpu_utilization)
...
add_test_cases("test_select_response_time", iters_response_time, timeout_response_time)
add_test_cases("test_cpu_utilization_select", iters_cpu_utilization, timeout_cpu_utilization)
add_test_cases("test_cpu_utilization_overall", iters_cpu_utilization, timeout_cpu_utilization)
